...
"The growing burden of type 2 diabetes mellitus (T2DM) and diabetic retinopathy (DR) necessitates improved healthcare strategies. Despite national guidelines in Chile for glycemic control and annual DR screening, significant disparities exist in coverage across municipalities \[\@SILVA-JORQUERA2021\]. This heterogeneity suggests potential sub-populations with distinct trajectories in T2DM management. Latent class mixture modeling (LCMM), a novel approach in this context, offers an opportunity to identify such groups based on longitudinal data on HbA1c levels and DR screening coverage. By uncovering these unique trajectories and their associations with area-level sociodemographic characteristics, our study aims to inform targeted interventions and improve evidence-based policies for effective T2DM management and DR prevention at the local level."
...
The global rise in the prevalence of diabetes mellitus (DM), particularly type 2 DM (T2DM), has placed a significant strain on health systems worldwide [@idf_2021]. This burden is particularly acute in managing vision-threatening complications arising from poor glycemic control. Diabetic retinopathy (DR), a leading cause of avoidable blindness and vision impairment in working-age adults [@burton_lancet_2021], poses a major public health concern. The World Health Organization (WHO) emphasizes the importance of improved diabetes management and quality of care, including achieving and maintaining glycated hemoglobin (HbA1c) levels below 7% [@who]. This target aligns with the success story of DR no longer being the leading cause of blindness among working-age adults in England, following the implementation of a systematic national DRS program [@liew_comparison_2014]. These findings underscore the importance of comprehensive and equitable healthcare strategies in tackling T2DM and its complications.

<!--Inequalities in Diabetes Management and Screening Coverage-->

Inadequate diabetes management, coupled with a lack of early DR detection and treatment, can have devastating consequences beyond vision loss. Studies suggest it can lead to social and emotional distress [@fenwick_social_2012], limit participation in daily activities and job opportunities [@cooper_psychological_2020], and have significant economic repercussions [@pdb52_2019]. Ultimately, these factors can profoundly impact the quality of life for individuals with T2DM [@trento_quality_2013].

However, the effectiveness of diabetes management strategies, including DR screening (DRS), varies significantly at the local level in Chile, as evidenced by studies highlighting inequalities in DRS coverage (DRSC) across municipalities [@SILVA-JORQUERA2021; @guerrero-núñez2017]. Similar findings have been reported in other countries [@elek2021]. These inequalities are likely influenced by factors like deprivation, urbanicity, and geographical location, as observed in other countries,[@patel2022; @elek2021; @ravindranath2023; @davis2023; @rawlingschidi2024] reflecting differences in healthcare service policy and provision related to DM management. [@guerrero-núñez2017; @elek2021].

<!--Understanding Sub-population Heterogeneity in the Context of Inequalities-->

It is crucial to understand the differences in DRS coverage within Chilean municipalities in order to address observed inequalities. National guidelines established by the Chilean Cardiovascular Health Program for HbA1c monitoring and annual DRS highlight a commitment to diabetes management and DR prevention[@minsal2017]. studies have revealed significant disparities in achieving these targets across municipalities in Chile.[@SILVA-JORQUERA2021; @guerrero-núñez2017] However, despite these guidelines, substantial differences persist in achieving targets across Chilean municipalities. By identifying these subpopulations and exploring the relationship between area-level demographics, deprivation characteristics, and their identified trajectories, we can develop targeted interventions to meet the specific needs of each subpopulation, ultimately improving overall diabetes management and access to DRS at the local level.

<!--National guidelines established by the Chilean Cardiovascular Health Program (CHP) for HbA1c monitoring and annual DRS highlight a commitment to diabetes management and DR prevention [@minsal2017]. However, studies reveal substantial inequalities in achieving these targets across Chilean municipalities [@SILVA-JORQUERA2021; @guerrero-núñez2017]. These differences suggest the presence of potential sub-populations within the national data. These sub-populations may exhibit distinct patterns regarding glycemic control and DRSC, influenced by factors like deprivation, urbanicity, and geographical location, as observed in other countries.[@patel2022; @elek2021; @ravindranath2022; @davis2022; @rawlingschidi2024] Understanding this heterogeneity is crucial for addressing the observed inequalities. This knowledge can inform the development of targeted interventions that serve to the specific needs of each sub-population and ultimately improve overall diabetes management and access to DRS at the local level. -->

<!--Latent Class Mixture Modeling: A Novel Approach-->

Traditional statistical approaches often assume homogeneity within the population under study. However, in the context of T2DM management, there might be distinct sub-populations with unique trajectories in achieving glycemic control and undergoing DRS. Latent class mixture modeling (LCMM) is an unsupervised machine learning technique that can identify these sub-populations based on observed characteristics [@berlin_introduction_2014; @miettunen2016]. However, to the best of our knowledge, no prior research has applied Latent Class Mixture Modeling (LCMM) to investigate sub-population heterogeneity and its association with these factors in the context of T2DM management and DRS coverage in Chile. By applying LCMM to longitudinal data on T2DM management and DRS coverage across Chilean municipalities, we aimed to reveal unique trajectory patterns in achieving glycemic control and undergoing DRS. Additionally, this study sought to investigate the relationship between area-level demographic and deprivation characteristics with these identified trajectories. Although these analyses were conducted at the ecological level, the results may be useful for identifying groups of municipalities that perform better or worse than the national average, providing valuable information for further research.
...
We analyzed municipality-level data from 2011 to 2023, focusing on adults aged ≥ 15 years who were diagnosed with type 2 diabetes mellitus (T2DM) and covered by the public health scheme.

We sourced our data for T2DM management from the Statistical and Health Information Department, which provides these through the CHP.[@deis] We used two outcome indicators: the proportion of T2DM patients achieving target an adequate glycemic control (HbA1c \< 7%), referred to as diabetic glycemic control coverage (DGCC), and those undergoing annual diabetic retinopathy screening (DRS). DGCC represents the percentage of the T2DM population maintaining an HbA1c level below 7%, whereas DRS coverage (DRSC) indicates the percentage undergoing annual DRS. The numerators for both metrics were based on the population with glycemic control below 7% for DGCC and those undergoing annual DRS for DRSC. The denominator was the total T2DM population. We used integrated data because sex-specific data were not completely available. We considered deprivation, urbanicity, and geographical location to test the associations between various sociodemographic factors and class membership coverage.

For deprivation, we utilized the Index of Socioeconomic Development (ISDE) score developed in 2013 by the Chilean Observatory of Public Health (OCHISAP). This index evaluates local deprivation levels (ranging from 0 to 1, with lower scores indicating greater deprivation) and comprises three components: income, education, and housing and sanitation.[@gattini_comunas_2013]

For urbanicity, we utilized the metrics used by The National Statistics Institute, which determined urbanicity by following the methodological framework outlined in the National Policy of Rural Development.[@bergamini2020] Municipalities were categorized based on population density as predominantly rural (more than 50% of the population residing in low-density areas), mixed (25%--49% in low-density areas), and predominantly urban (less than 25% in low-density areas).

We used the Environmental Tribunals of Chile classification for the geographical location, subdividing the country into three zones: north, centre, and south. This classification simplifies the geographical locations of municipalities into three levels.

Thus, we analyzed the unadjusted and adjusted associations with deprivation, urbanicity, and geographical location.

## Statistical analyses

Our study employed a two-stage analysis. First, we used latent class mixture modelling (LCMM) to analyze DRSC and DRSC longitudinal data. LCMM uses probabilistic assignment to latent classes, which represent subgroups or trajectories and allow the identification of unique patterns within a given population [@berlin_introduction_2014]. We delineated trajectory classes for DRSC and DGCC from 2011 to 2023. We gradually expanded from one class cluster into six class clusters.

We evaluated models based on their goodness-of-fit, including Akaike Information Criteria (AIC), Bayesian Information Criteria (BIC), sample-adjusted Bayesian Information Criteria (SABIC), Consistent Akaike Information Criterion (CAIC), Approximate Weight of Evidence Criterion (AWE), Bayes Factor (BF), and correct model probability (cmP). Additionally, we used diagnostic tests such as entropy, smallest class count (SCC) and size (SCS), and minimum Average Latent Class Posterior Probability (ACPP). The Vuong--Lo--Mendell--Rubin (VL-LRT) test assessed overall model fit, comparing a model with k-classes to a model with k-1 classes. We rejected the k-1 class model in favor of the k-class model based on a p-value threshold of p\<0.05, considering clinical plausibility, model fit, and diagnostic criteria.[@wickrama2021]

We hypothesized that the intercept and slope represent random effects across municipalities. We conducted a sensitivity analysis between 2011 and 2019 to evaluate whether excluding the pandemic years (2019-2023) impacted the DRSC and DRSC trajectory results. As the LCMM deals with missing data, it is unnecessary to have complete data for each year in each municipality. However, we checked the data completeness over time by comparing means using Welch's two-sample t-test and verified the data balance between selected trajectories.

Second, we analyzed the factors influencing membership across different trajectories. This analysis helped us determine whether municipal-level deprivation, urbanicity, and geographical location were associated with trajectory-class membership. To ensure the validity of our distribution assumptions, we standardized the ISDE for deprivation to meet the distribution requirements of the model.

For statistical analyses, we utilized R version 4.3.1 and the "lcmm" package version 2.1.0
...
ggplot(dr1, aes(x=ano2, y=drs_coverage, colour = as.factor(class), group = comuna2)) +
  ...
  #scale_color_lancet()+
  scale_color_lancet(labels = c("206 trajectories (68.7%)", "94 trajectories (31.3%)")) 
...
#data_summary4 <- cbind(data_summary4, obs2023)
...
#data_summary5 <- cbind(data_summary5, obs2019)
...
mfc1 <- read.csv("model_fit_criteria_2011_2023_noq1.csv", sep=",") 
...
dc1 <- read.csv("diagnostic_criteria_2011_2023_noq1.csv", sep=",") 
...
mfc2 <- read.csv("model_fit_criteria_2011_2019_noq1.csv", sep=",") 
...
dc2 <- read.csv("diagnostic_criteria_2011_2019_noq1.csv", sep=",") 
...
",
   ...
   tab_source_note(source_note = md(" **Abbreviations:** LCMM - Latent Class Mixture Model; M-Loglik – Maximum Log-likelihood; AIC- Akaike Information Criteria; BIC - Bayesian Information Criteria; SABIC - Sample-Adjusted Bayesian Information Criteria; SS - Sample size; CAIC -  Consistent Akaike Information Criterion; AWE- Approximate Weight of Evidence Criterion; SIC - Schwarz Information Criterion; BF - Bayes Factor; cmP- correct model probability; SCC - Smallest Class Count; SCS - Smallest Class Size; Lowest APPA: Lowest Average Class Posterior Probability; VL-LRT: Vuong–Lo–Mendell–Rubin Likelihood Radio Test."))
...
#| fig-align: center
 ...
 m1dm_noq1 <- lcmm::hlme(dm_coverage ~ ano2, random = ~ano2, subject = "comuna2", ng = 1, data = coverage1)


# Create a data frame with all coefficients, standard errors, and p-values
df2 <- data.frame(
  Metric = rep(c('Intercept', 'Slope'), 6),
  Model_1_B = c(m1dm_noq1$best[1], m1dm_noq1$best[2], NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_1_SE = c(0.00532, 0.00057, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_1_P = c('<0.001', '<0.001', NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_2_B = c(0.47095, -0.01182, 0.47395, -0.01169, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_2_SE = c(0.20805, 0.02449, 0.20813, 0.02450, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_2_P = c(0.0236, 0.6294, 0.0228, 0.6333, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_3_B = c(0.47650, -0.01180, 0.39145, -0.01176, 0.58693, -0.01098, NA, NA, NA, NA, NA, NA),
  Model_3_SE = c(0.00638, 0.00066, 0.02467, 0.00252, 0.04545, 0.00486, NA, NA, NA, NA, NA, NA),
  Model_3_P = c('<0.001', '<0.001', '<0.001', '<0.001', 0.0237, 0.0237, NA, NA, NA, NA, NA, NA),
  Model_4_B = c(0.48596, 0.00030, 0.47596, -0.01183, 0.38895, -0.01155, 0.67399, -0.02220, NA, NA, NA, NA),
  Model_4_SE = c(0.06071, 0.00794, 0.00642, 0.00066, 0.02386, 0.00245, 0.05713, 0.00725, NA, NA, NA, NA),
  Model_4_P = c('<0.001', 0.9695, '<0.001', '<0.001', '<0.001', '<0.001', '<0.001', 0.0022, NA, NA, NA, NA),
  Model_5_B = c(0.25251, 0.00293, 0.40936, -0.01376, 0.47507, -0.01172, 0.67407, -0.02246, 0.48433, 0.00043, NA, NA),
  Model_5_SE = c(0.07318, 0.00805, 0.02787, 0.00321, 0.00667, 0.00067, 0.05563, 0.00755, 0.06012, 0.00770, NA, NA),
  Model_5_P = c('<0.001', 0.7157, '<0.001', '<0.001', '<0.001', '<0.001', '<0.001', '<0.001', '<0.001', 0.9552, NA, NA),
  Model_6_B = c(0.60359, -0.02719, 0.45123, 0.00383, 0.45745, -0.00943, 0.25000, 0.00402, 0.43168, -0.01617, 0.65527, -0.01895),
  Model_6_SE = c(0.02957, 0.00298, 0.03443, 0.00445, 0.00763, 0.00102, 0.04324, 0.00412, 0.02181, 0.00227, 0.03161, 0.00362),
  Model_6_P = c('<0.001', '<0.001', '<0.001', 0.3898, '<0.001', '<0.001', '<0.001', 0.3296, '<0.001', '<0.001', '<0.001', '<0.001')
)
...
df3 <- data.frame(
  Metric = rep(c('Intercept', 'Slope'), 6),
  Model_1_B = c(0.28452, 0.01592, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_1_SE = c(0.01158, 0.00171, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_1_P = c('<0.001', '<0.001', NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_2_B = c(0.23049, 0.01379, 0.43580, 0.02157, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_2_SE = c(0.01648, 0.00304, 0.04315, 0.00690, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_2_P = c('<0.001', '<0.001', '<0.001', 0.00177, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_3_B = c(0.30780, 0.02962, 0.23102, 0.01105, 0.50780, 0.01670, NA, NA, NA, NA, NA, NA),
  Model_3_SE = c(0.11649, 0.01374, 0.02229, 0.00479, 0.13040, 0.01742, NA, NA, NA, NA, NA, NA),
  Model_3_P = c(0.00823, 0.03117, '<0.001', 0.02099, '<0.001', 0.33763, NA, NA, NA, NA, NA, NA),
  Model_4_B = c(0.39021, 0.02452, 0.15585, 0.00859, 0.26987, 0.01553, 0.57245, 0.01985, NA, NA, NA, NA),
  Model_4_SE = c(0.02692, 0.00450, 0.02142, 0.00383, 0.01656, 0.00283, 0.05103, 0.00836, NA, NA, NA, NA),
  Model_4_P = c('<0.001', '<0.001', '<0.001', 0.02507, '<0.001', '<0.001', '<0.001', 0.01755, NA, NA, NA, NA),
  Model_5_B = c(0.37025, -0.01473, 0.19829, 0.01988, 0.71851, -0.08157, 0.30240, 0.04135, 0.59626, -0.00388, NA, NA),
  Model_5_SE = c(0.09450, 0.00796, 0.03533, 0.00374, 0.11366, 0.01527, 0.07324, 0.00735, 0.10121, 0.02139, NA, NA),
  Model_5_P = c(0.00009, 0.06424, '<0.001', '<0.001', '<0.001', '<0.001', '<0.001', '<0.001', '<0.001', 0.85606, NA, NA),
  Model_6_B = c(0.13301, 0.00668, 0.16239, 0.01024, 0.26584, 0.01671, 0.83830, -0.08345, 0.39427, 0.02398, 0.57798, 0.01895),
  Model_6_SE = c(0.07913, 0.01323, 0.03200, 0.00538, 0.01690, 0.00285, 0.17573, 0.03310, 0.02497, 0.00422, 0.04764, 0.00785),
  Model_6_P = c(0.09278, 0.61338, '<0.001', 0.05713, '<0.001', '<0.001', '<0.001', 0.01169, '<0.001', '<0.001', '<0.001', 0.01579)
)
...
df4 <- data.frame(
  Metric = rep(c('Intercept', 'Slope'), 6),
  Model_1_B = c(0.32351, 0.00295, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_1_SE = c(0.01191, 0.00137, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_1_P = c('<0.001', '0.03098', NA, NA, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_2_B = c(0.27850, -0.00044, 0.42144, 0.01009, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_2_SE = c(0.02506, 0.00255, 0.04093, 0.00573, NA, NA, NA, NA, NA, NA, NA, NA),
  Model_2_P = c('<0.001', '0.86297', '<0.001', '0.07824', NA, NA, NA, NA, NA, NA, NA, NA),
  Model_3_B = c(0.27850, -0.00044, 0.27850, -0.00044, 0.42145, 0.01009, NA, NA, NA, NA, NA, NA),
  Model_3_SE = c(0.07834, 0.00467, 0.07825, 0.00467, 0.04091, 0.00573, NA, NA, NA, NA, NA, NA),
  Model_3_P = c('<0.001', '0.92484', '<0.001', '0.92474', '<0.001', '0.07827', NA, NA, NA, NA, NA, NA),
  Model_4_B = c(0.24920, -0.00192, 0.34107, 0.00338, 0.81102, -0.03659, 0.35070, 0.02404, NA, NA, NA, NA),
  Model_4_SE = c(0.02865, 0.00363, 0.04788, 0.00427, 0.12427, 0.01352, 0.03889, 0.00434, NA, NA, NA, NA),
  Model_4_P = c('<0.001', '0.59688', '<0.001', '0.42876', '<0.001', '0.00682', '<0.001', '<0.001', NA, NA, NA, NA),
  Model_5_B = c(0.55548, -0.01261, 0.34034, -0.01563, 0.24908, 0.00634, 0.98083, -0.05630, 0.31158, 0.02728, NA, NA),
  Model_5_SE = c(0.11801, 0.01221, 0.09703, 0.01063, 0.03346, 0.00269, 0.19292, 0.01994, 0.03651, 0.00361, NA, NA),
  Model_5_P = c('<0.001', '0.30166', '<0.001', '0.14150', '<0.001', '0.01834', '<0.001', '0.00475', '<0.001', '<0.001', NA, NA),
  Model_6_B = c(0.23471, -0.00251, 0.45760, -0.02630, 0.56029, -0.01189, 0.24592, 0.00758, 0.98162, -0.05622, 0.30263, 0.02836),
  Model_6_SE = c(0.05618, 0.00928, 0.07062, 0.00638, 0.08485, 0.00923, 0.03318, 0.00309, 0.15698, 0.01689, 0.03549, 0.00362),
  Model_6_P = c('<0.001', '0.78693', '<0.001', '0.00004', '<0.001', '0.19764', '<0.001', '0.01412', '<0.001', '0.00087', '<0.001', '<0.001')
)
