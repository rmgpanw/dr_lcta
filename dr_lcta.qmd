...
-   Diabetic Glycemic Control Coverage (DGCC) : Proportion of T2DM patients achieving adequate glycemic control, defined as HbA1c \< 7%.

-   Diabetic Retinopathy Screening Coverage (DRSC) : Proportion of patients receiving annual diabetic retinopathy screening (DRS).

For both indicators, the numerators were based on the number of patients with HbA1c \< 7% for DGCC and those who underwent the DRS for DRSC, with the denominator being the total T2DM population. To improve representativeness, we excluded municipalities in the lowest population-size quintile. These smaller municipalities often showed extreme coverage percentages (e.g., 0% or 100%) because of their small T2DM populations, which could have skewed the results.
...
-   **Class 1** (lower DRSC coverage) showed a stable baseline coverage and minimal annual changes. For the 2011-2023 period, the baseline coverage was 24.8%, with an annual change of 0.4% (p = 0.068). In the 2011-2019 period, Class 1 had a baseline coverage of 23.05%, with an annual change of 1.38% (p \< 0.001).

-   **Class 2** (higher DRSC coverage) exhibited higher baseline coverage and notable annual changes. In the 2011-2023 period, the baseline coverage was 43.7%, with an annual change of 0.69% (p = 0.073). In the 2011-2019 period, Class 2 had a baseline coverage of 43.58%, with an annual change of 2.16% (p = 0.002).
...
-   **2011-2019 period**: OR = 0.53 (95% CI: 0.39, 0.73)
...
Urbanicity has varying effects on DRSC coverage. Rural areas exhibited significantly higher odds of better coverage than mixed-urban areas.

-   **2011-2023 period**: Rural areas had an OR of 1.79 (95% CI: 0.99, 3.21), indicating higher odds of being in the higher coverage class compared to mixed urban areas (reference category). Urban areas had an OR of 0.39 (95% CI: 0.17, 0.84), suggesting lower odds compared to mixed urban areas.

-   **2011-2019 period**: Rural areas had an OR of 2.73 (95% CI: 1.41, 5.30), while urban areas had an OR of 0.47 (95% CI: 0.19, 1.19).

These results suggest that rural municipalities generally had higher DRSC coverage, whereas urban municipalities exhibited more mixed results.

### Geographical Location

Geographical location also played a significant role in DRSC class membership. In the **2011-2023 period**, municipalities in the southern region showed a higher likelihood of being in the higher-coverage DRSC class:

-   **2011-2023 period**: the Southern region had an OR of 1.02 (95% CI: 0.42, 2.51), compared to the central region (reference category).

-   **2011-2019 period**: The southern region had a higher odds ratio of 1.84 (95% CI: 1.11, 3.08), suggesting a strong positive association with higher DRSC coverage, while the northern region had a relatively neutral impact.
...
#| label: fig-2
#| warning: false
#| fig-cap: "Latent class trajectory mixture models solutions for diabetic glycemic control and diabetic retinopathy screening coverage across 300 (2011-2023) and 292 (2011-2019) municipalities"
#| fig-subcap: 
#| - "Diabetic Glycemic Control Coverage"
#| - "Diabetic Retinopathy Screening Coverage"
#| layout-ncol: 2
